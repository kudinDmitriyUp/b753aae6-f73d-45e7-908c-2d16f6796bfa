...
export const metadata: Metadata = {
  title: "Amore Mio - Authentic Italian Restaurant in Milano",
  description: "Experience premium Italian cuisine at Amore Mio, Milano's finest restaurant. Traditional recipes, fresh ingredients, elegant atmosphere. Reserve your table today.",
  keywords: "italian restaurant milano, authentic italian food, fine dining milan, italian cuisine, restaurant reservations milano, amore mio",
  metadataBase: new URL("https://amoremio.com"),
  alternates: {
    canonical: "https://amoremio.com"
  },
  openGraph: {
    title: "Amore Mio - Premium Italian Dining Experience",
    description: "Discover authentic Italian flavors in Milano's most elegant restaurant. Traditional recipes, premium ingredients, unforgettable atmosphere.",
    siteName: "Amore Mio Ristorante",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763632245608-io4f1x1s.jpg",
        alt: "Amore Mio restaurant interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Amore Mio - Authentic Italian Restaurant Milano",
    description: "Experience the finest Italian cuisine in Milano. Premium ingredients, traditional recipes, elegant atmosphere.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763632245608-io4f1x1s.jpg"]
  },
  robots: {
    index: true,
    follow: true
